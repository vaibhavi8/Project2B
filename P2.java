...
public class P2 {
  ...
  public static int[][] dijkstraPrint(int a[][]){
    int nodeCount = a[0].length;
    // System.out.println("length is " + nodeCount);
    int[][] dist = new int[nodeCount-1][nodeCount];   //
    int[][] prev = new int[nodeCount-1][nodeCount];   //
...
public static int[][] floydWarshallPrint(int a[][]){
    int n = a.length;
    int[][] prev = new int[n][n];
    int [][] curr = new int[n][n];
    prev = a;
  ...
  public static void main(String[] args) {
    ...
    int[][] graphA = { {0,7,12,inf,inf,inf}, {inf,0,2,9,inf,inf}, {inf,inf,0,inf,10,inf}, {inf,inf,inf,0,inf,1}, {inf,inf,inf,4,0,5}, {inf,inf,inf,inf,inf,0} };
    ...
    System.out.println("Dijkstra took " + timeTook/1000 + " seconds for 1000 interations of the fixed graph for a sanity check.");

    floydWarshallPrint(graphA);
    startTime = System.nanoTime();
    for(int i = 0; i < 1000; i++){
    ...
    endTime = System.nanoTime();
    timeTook = (endTime-startTime)/1000000000;
    System.out.println("Floyd-Warshall took " + timeTook/1000 + " seconds for 1000 interations of the fixed graph for a sanity check.");
